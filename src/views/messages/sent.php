...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'format' => 'raw',
            'value' => function($model) {
                return Html::tag('span', Yii::$app->formatter->asRelativeTime($model->created_at), [
                    'data-toggle' => 'tooltip', 
                    'data-placement' => 'top', 
                    'title' => Yii::$app->formatter->asDatetime($model->created_at, 'long')
                ]);
            }
        ],
        [
            ...
            'buttons' => [
                ...
                'delete-sent' => function($url) {
                    ...
                    ])), ['data-toggle' => 'modal', 'data-target' => '#podiumModal', 'data-url' => $url]);
                },
            ],
        ]
    ],
