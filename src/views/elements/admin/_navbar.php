...
echo Html::tag('li', Html::a('<span class="glyphicon glyphicon-bullhorn"></span> ' . Yii::t('podium/view', 'Forums'), ['forums']), ['role' => 'presentation', 'class' => $active == 'forums' ? 'active' : null]);
