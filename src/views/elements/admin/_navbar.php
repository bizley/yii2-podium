...
echo Html::tag('li', Html::a('<span class="glyphicon glyphicon-scissors"></span> ' . Yii::t('podium/view', 'Moderators'), ['mods']), ['role' => 'presentation', 'class' => $active == 'mods' ? 'active' : null]);
