...
if (Yii::$app->user->isGuest) {
    ...
    $items[] = [
        ...
        'items' => [
            ...
            ['label' => Yii::t('podium/view', 'Messages') . ' ' . Html::tag('span', '0/0', ['class' => 'badge']), 'url' => ['profile/messages']],
            ['label' => Yii::t('podium/view', 'Subscriptions') . ' ' . Html::tag('span', '0/0', ['class' => 'badge']), 'url' => ['profile/subscriptions']],
        ]
    ];
