...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="#"><span class="glyphicon glyphicon-comment"></span> <?= Yii::t('podium/view', 'Posts created by {name}', ['name' => $user->getPodiumName()]) ?></a></li>
</ul>
<br>
<?php Pjax::begin();
